...
async function loadCategories() {
  try {
    const res = await fetch('/peluqueria/php/api/categories_api.php?action=allAdmin');
...
async function loadCategories() {
  ...
  populateServiceCategorySelect(); // mantiene sincronizado el <select> del modal de servicios
}
...
// Rellena el <select> de categoría en el modal de servicios con las categorías activas
