...
<nav class="client-nav"><a href="client/profile.php">👤 <span>Mi perfil</span></a><a href="client/reservations.php">📅 <span>Mis reservas</span></a><a href="client/calendar.php">🕐 <span>Mi horario</span></a><a href="client/reviews.php">⭐ <span>Mis reseñas</span></a><div class="client-nav-separator"></div><a href="client/account.php">⚙️ <span>Opciones de cuenta</span></a><a href="client/account.php#security">🔒 <span>Seguridad</span></a><a class="client-logout" href="php/auth/logout.php">🚪 <span>Cerrar sesión</span></a></nav>
</aside>